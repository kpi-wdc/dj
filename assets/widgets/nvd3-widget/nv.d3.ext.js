  ...
  nv.models.colorScheme = function () {
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        console.log("gColorScheme",gColorScheme)
        ...
        console.log("NEW", values.enter())
        console.log("removed", values.exit())
        values.exit().remove();
        console.log("After removed", values.exit())
       ...
       console.log("values",values)  
        ...
        // wrap
        //   .select("rect.nv-color-bg")
        //   .transition()
        //   .attr("width", availableWidth / 2 + 25)
        //   .attr("height", 40);
