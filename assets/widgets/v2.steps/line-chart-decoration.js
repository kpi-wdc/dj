...
m.factory("LineChartDecoration",[
	"Palettes", "$http","parentHolder","Requestor", "LineChartAdapter", 
	function(Palettes,$http, parentHolder, Requestor, LineChartAdapter ){
	return {
	   ...
	   setupOptions: function(){
		...
		activate : function(wizard){
	        ...
	        .push("getOptions",function(requestor){
	          $http.get("./widgets/nvd3-line/options.json")
	          .success(function(data){
	             thos.options = data;
                
	            if(thos.decoration){
	            	LineChartAdapter.applyDecoration(thos.options,thos.decoration)
	            }else{
	            	thos.decoration = LineChartAdapter.getDecoration(thos.options);
	            }
		...
		apply: function(){
			...
			LineChartAdapter.applyDecoration(this.options,this.decoration);
