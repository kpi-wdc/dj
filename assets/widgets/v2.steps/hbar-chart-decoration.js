...
m.factory("HBarChartDecoration",[
	"Palettes", "$http","parentHolder","Requestor", "HBarChartAdapter", 
	function(Palettes,$http, parentHolder, Requestor, HBarChartAdapter ){
	return {
		...
		activate : function(wizard){
	        ...
	        .push("getOptions",function(requestor){
	          $http.get("./widgets/v2.nvd3-bar-h/options.json")
	          .success(function(data){
	             thos.options = data;
                
	            if(thos.decoration){
	            	HBarChartAdapter.applyDecoration(thos.options,thos.decoration)
	            }else{
	            	thos.decoration = HBarChartAdapter.getDecoration(thos.options);
	            }
		...
		apply: function(){
			...
			HBarChartAdapter.applyDecoration(this.options,this.decoration);
