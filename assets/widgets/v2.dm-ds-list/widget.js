...
let m = angular.module('app.widgets.v2.dm-ds-list', ['app.dictionary','app.dps','ngFileUpload','react','custom-react-directives'])
  m.controller('DataManagerSearchResultListController', function ($scope, $http, $dps, EventEmitter, 
