...
statkit.max = max;
statkit.range = range;
statkit.quantile = quantile;
statkit.median = median;
statkit.iqr = iqr;
statkit.mean = mean;
statkit.gmean = gmean;
statkit.hmean = hmean;
...
statkit.kurt = kurt;
statkit.corr = corr;
statkit.entropy = entropy;
statkit.kldiv = kldiv;
statkit.shuffle = shuffle;
statkit.sample = sample;
statkit.boot = boot;
statkit.bootci = bootci;
statkit.randn = randn;
statkit.erf = erf;
statkit.normcdf = normcdf;
statkit.norminv = norminv;
statkit.lufactor = lufactor;
statkit.lusolve = lusolve;
statkit.qrfactor = qrfactor;
statkit.qrsolve = qrsolve;
statkit.lstsq = lstsq;
