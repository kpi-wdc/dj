...
const m = angular.module('app.widgets.data-dialogs.scatter-chart-dialog', [
...
m.factory("ScatterChartDialog", ['KeySet', 'TableGenerator', 'ScatterSerieGenerator', '$modal',
  ...
  function (KeySet, TableGenerator, ScatterSerieGenerator, $modal,
    ...
    var ScatterChartDialog = function (scope) {
    ...
    ScatterChartDialog.prototype = {
      ...
      open: function () {
        ...
        var s = this.scope;
        $modal.open({
          templateUrl: 'widgets/data-dialogs/scatter-chart-dialog.html',
          controller: 'ScatterChartConfigDialog',
          backdrop: 'static',
          resolve: {
    ...
    return ScatterChartDialog;

  }]);

m.controller('ScatterChartConfigDialog', function ($scope, $modalInstance, widgetScope) {
