...
const m = angular.module('app.widgets.data-dialogs.map-chart-dialog', [
...
m.factory("MapChartDialog", ['KeySet', 'TableGenerator', 'BarSerieGenerator', '$modal',
  ...
  function (KeySet, TableGenerator, BarSerieGenerator, $modal,
    ...
    var MapChartDialog = function (scope) {
      ...
      this.conf = {
        storeDatasource: scope.widget.datasource,
        datasource: scope.widget.datasource,
        instanceName: scope.widget.instanceName,
    ...
    MapChartDialog.prototype = {
      ...
      open: function () {
        ...
        var s = this.scope;
        $modal.open({
          templateUrl: 'widgets/data-dialogs/map-chart-dialog.html',
          controller: 'MapChartConfigDialog',
          backdrop: 'static',
          resolve: {
    ...
    return MapChartDialog;

  }]);

m.controller('MapChartConfigDialog', function ($scope, $modalInstance, widgetScope) {
