...
const m = angular.module('app.widgets.data-dialogs.distribution-dialog', [
...
m.factory("DistributionDialog", ['KeySet', 'TableGenerator', 'DistributionSerieGenerator', '$modal',
  'APIUser', 'APIProvider', 'pageSubscriptions', 'pageWidgets',
  'Palettes1',

  function (KeySet, TableGenerator, DistributionSerieGenerator, $modal,
            APIUser, APIProvider, pageSubscriptions, pageWidgets,
            Palettes1) {

    var DistributionDialog = function (scope) {
    ...
    DistributionDialog.prototype = {
      ...
      setState: function () {
        switch (arguments[0]) {
          ...
          case 4:
            ...
            if (this.readyForSerieGeneration() == false) {
              this.setDisabled([this.steps[4]])
            } else {
              this.setEnabled([this.steps[4]])
            }
          ...
          case 5: // Set widget data configuration
            this.series = DistributionSerieGenerator.getData(this.table, this.scope);
      ...
      open: function () {
        ...
        var s = this.scope;
        $modal.open({
          templateUrl: 'widgets/data-dialogs/distribution-dialog.html',
          controller: 'DistributionConfigDialog',
          backdrop: 'static',
          resolve: {
...
m.controller('DistributionConfigDialog', function ($scope, $modalInstance, widgetScope) {
