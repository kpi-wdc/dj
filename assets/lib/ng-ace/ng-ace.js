 ...
 */
angular.module('ng.ace', [])
  .constant('ngAceConfig', {})
  .directive('ngAce', ['ngAceConfig', function (ngAceConfig) {

    if (angular.isUndefined(window.ace)) {
      throw new Error('ng-ace need ace to work... (o rly?)');
    }
    ...
    return {
      ...
      link: function (scope, elm, attrs) {
        ...
        var updateOptions = function (current, previous) {
          ...
          opts = angular.extend({}, options, scope.options);
        ...
        scope.$watch('options', updateOptions, /* deep watch */ true);
