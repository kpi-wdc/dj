define([
        ...
        '/widgets/data-dialogs/distribution-dialog.js'
    ],
    function (angular) {

        var m = angular.module('app.widgets.nvd3-distribution', [
        ...
        m.service('NVD3DistributionAdapter', function () {
               this.applyDecoration = function (options, decoration) {
                    if(angular.isDefined(decoration)&&angular.isDefined(options)) {
                        ...
                        options.chart.lines.label = (decoration.showLabels) ? function(d){return d.y} : undefined;
