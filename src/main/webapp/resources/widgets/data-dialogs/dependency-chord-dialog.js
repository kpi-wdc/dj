...
define(["angular",
    ...
    function (angular) {
        var m = angular.module('app.widgets.data-dialogs.dependency-chord-dialog', [
        ...
        m.factory("DependencyChordDialog", ['KeySet','TableGenerator','CorrelationTableGenerator',
            'CorrelationMatrixGenerator','$modal',
            'APIUser','APIProvider','pageSubscriptions','pageWidgets',
            'Palettes1',

            function(KeySet, TableGenerator, CorrelationTableGenerator, CorrelationMatrixGenerator,
                     $modal,APIUser, APIProvider, pageSubscriptions, pageWidgets,
                     Palettes1) {

                var DependencyChordDialog = function(scope){
                ...
                DependencyChordDialog.prototype =  {
                    ...
                    getCellBackground: function(row,col,value){
                        ...
                        switch (this.conf.decoration.colorizeMode){
                            case "Rows":
                                ...
                                break;
                            case "Columns":
                                col = Object.keys(row.values).sort(function(a,b){return(a<b)? -1 : 1})[col];
                        ...
                        switch (arguments[0]) {
                            ...
                            case 3: // get data from dataset provider, fields role selection in process
                                ...
                                if (arguments[0] && this.state < arguments[0]) {
                                    ...
                                    this.series = CorrelationMatrixGenerator.getData(this.table)
                    ...
                    open: function(){
                        ...
                        var s = this.scope;
                        $modal.open({
                            templateUrl: 'widgets/data-dialogs/dependency-chord-dialog.html',
                            controller: 'DependencyChordConfigDialog',
                            backdrop: 'static',
                            resolve: {
                ...
                return DependencyChordDialog;

            }]);


        m.controller('DependencyChordConfigDialog', function ($scope, $modalInstance, widgetScope) {
