...
// var selection = new query()
// 					.concat(jp.query(data,"$..metadata.dataset[?(@.source == '#WB')].source"))
// 					.group(function(item){return {key:item, value:item}})
// 					.map(function(item){
// 						return {
// 							key:item.key,
...
// 						}
// 					})
// 					.order(query.criteria.Number["Z-A"](function(item){
// 						return item.count
// 					}))
// 					.get();
...
console.log(jp.query(data,'$[?(@.metadata.dataset.topics.contains(function(item){return item.startWith("#SD")}))]'))
// 
// var data = { "store": {
//     "book": [ 
//       { "category": "reference",
