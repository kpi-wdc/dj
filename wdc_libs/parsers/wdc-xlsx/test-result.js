country { label: '#DIM_COUNTRY',
  ...
  values: 
   [ { id: 'LBY', label: 'Libya' },
     ...
     { id: 'EAP', label: 'East Asia & Pacific (developing only)' },
     { id: 'EAS', label: 'East Asia & Pacific (all income levels)' },
     { id: 'ECA', label: 'Europe & Central Asia (developing only)' },
     { id: 'ECS',
       label: 'Europe & Central Asia (all income levels)' },
     { id: 'ECU', label: 'Ecuador' },
     { id: 'EGY', label: 'Egypt  Arab Rep' },
     { id: 'EMU', label: 'Euro area' },
     { id: 'ERI', label: 'Eritrea' },
     { id: 'ESP', label: 'Spain' },
     { id: 'EST', label: 'Estonia' },
     { id: 'ETH', label: 'Ethiopia' },
     { id: 'EUU', label: 'European Union' },
     { id: 'FCS', label: 'Fragile and conflict affected situations' },
     { id: 'FIN', label: 'Finland' },
     { id: 'FJI', label: 'Fiji' },
     { id: 'FRA', label: 'France' },
     { id: 'FSM', label: 'Micronesia Fed Sts' },
     { id: 'GAB', label: 'Gabon' },
     { id: 'GBR', label: 'United Kingdom' },
     { id: 'GEO', label: 'Georgia' },
     { id: 'GHA', label: 'Ghana' },
     { id: 'GIN', label: 'Guinea' },
     { id: 'GMB', label: 'Gambia  The' },
     ...
     { id: 'HKG', label: 'Hong Kong SAR  China' },
     { id: 'HND', label: 'Honduras' },
     { id: 'HPC', label: 'Heavily indebted poor countries (HIPC)' },
     ...
     { id: 'LMC', label: 'Lower middle income' },
     { id: 'LMY', label: 'Low & middle income' },
     { id: 'LSO', label: 'Lesotho' },
     { id: 'LTU', label: 'Lithuania' },
     { id: 'LUX', label: 'Luxembourg' },
     { id: 'LVA', label: 'Latvia' },
     { id: 'MAC', label: 'Macao SAR  China' },
     ...
     { id: 'MIC', label: 'Middle income' },
     { id: 'MKD', label: 'Macedonia  FYR' },
     { id: 'MLI', label: 'Mali' },
     { id: 'MLT', label: 'Malta' },
     { id: 'MNA',
     ...
     { id: 'NAC', label: 'North America' },
     { id: 'NAM', label: 'Namibia' },
     { id: 'NER', label: 'Niger' },
     { id: 'NGA', label: 'Nigeria' },
     { id: 'NIC', label: 'Nicaragua' },
     { id: 'NLD', label: 'Netherlands' },
     { id: 'NOC', label: 'High income: nonOECD' },
     { id: 'NOR', label: 'Norway' },
     { id: 'NPL', label: 'Nepal' },
     { id: 'NZL', label: 'New Zealand' },
     { id: 'OEC', label: 'High income: OECD' },
     { id: 'OED', label: 'OECD members' },
     { id: 'OMN', label: 'Oman' },
     { id: 'OSS', label: 'Other small states' },
     ...
     { id: 'PSS', label: 'Pacific island small states' },
     { id: 'QAT', label: 'Qatar' },
     ...
     { id: 'SRB', label: 'Serbia' },
     { id: 'SSA', label: 'Sub-Saharan Africa (developing only)' },
     { id: 'SSD', label: 'South Sudan' },
     { id: 'SSF', label: 'Sub-Saharan Africa (all income levels)' },
     { id: 'SST', label: 'Small states' },
     { id: 'STP', label: 'Sao Tome and Principe' },
     { id: 'SUR', label: 'Suriname' },
     { id: 'SVK', label: 'Slovak Republic' },
     ...
     { id: 'UGA', label: 'Uganda' },
     { id: 'UKR', label: '#UKR' },
     { id: 'UMC', label: 'Upper middle income' },
     { id: 'URY', label: 'Uruguay' },
     { id: 'USA', label: 'United States' },
     { id: 'UZB', label: 'Uzbekistan' },
     { id: 'VCT', label: 'St  Vincent and the Grenadines' },
     { id: 'VEN', label: 'Venezuela  RB' },
     { id: 'VNM', label: 'Vietnam' },
     { id: 'VUT', label: 'Vanuatu' },
     { id: 'PSE', label: 'West Bank and Gaza' },
     { id: 'WLD', label: 'World' },
     { id: 'WSM', label: 'Samoa' },
     { id: 'YEM', label: 'Yemen  Rep ' },
     { id: 'ZAF', label: 'South Africa' },
     { id: 'COD', label: 'Congo  Dem  Rep ' },
     { id: 'ZMB', label: 'Zambia' },
     { id: 'ZWE', label: 'Zimbabwe' } ] }
concept { label: '#DIM_INDICATOR',
  role: 'metric',
  scale: 'interval',
  unit: 'USD per capita',
  values: [ { id: 'GDP', label: 'GDP per capita (current US$)' } ] }
year { label: '#DIM_YEAR',
  role: 'time',
  format: 'YYYY',
  scale: 'ordinal',
  ...
  values: 
   [ { id: '2010',
       label: Fri Jan 01 2010 00:00:00 GMT+0200 (Финляндия (зима)) },
     { id: '2011',
       label: Sat Jan 01 2011 00:00:00 GMT+0200 (Финляндия (зима)) },
     { id: '2012',
       label: Sun Jan 01 2012 00:00:00 GMT+0200 (Финляндия (зима)) },
     { id: '2013',
       label: Tue Jan 01 2013 00:00:00 GMT+0200 (Финляндия (зима)) } ] }
region { label: 'Region',
  scale: 'nominal',
  role: 'geo',
  values: 
   [ { id: 'Europe & Central Asia', label: 'Europe & Central Asia' },
